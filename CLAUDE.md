...
### Slides
- Format: `.md` file with slide content for Canva
- Rules: `06-rules/slides.md` (formatting, flow, teacher notes, visual/meme suggestions)
...
│   └── slides.md          (slide creation rules)
...
3. **Generate flashcards** — verify against 3 requirements
4. **Link in MOC** — update roadmap, mark complete
