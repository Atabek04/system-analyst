...
# Совет: в реальном проекте многие SA начинают с ERD

Вы уже знаете Class Diagram — теперь видите, как они соотносятся.
...
> ERD и Class Diagram — не конкуренты, а взаимодополняющие инструменты. ERD — фокус на хранении, Class — на поведении.
