...
![Реальная лента: вертикальный список карточек, каждая с автором, картинкой и лайками](assets/endpoint-to-ui/scr-01-feed.png)
...
![Каталог Kaspi по запросу «Шоколад»: сетка карточек товаров с ценой, рассрочкой, рейтингом и числом отзывов](assets/endpoint-to-ui/scr-kaspi-catalog.png)
...
![Реальная страница одного видео: крупный заголовок, число просмотров, название канала, лайки](assets/endpoint-to-ui/scr-02-video.png)
...
![Страница товара Рахат на Kaspi: крупное фото, название, цена, рассрочка, выбор начинки и веса](assets/endpoint-to-ui/scr-kaspi-product.png)
...
![Вкладка отзывов о товаре Рахат: список отзывов с автором, датой, звёздами и текстом](assets/endpoint-to-ui/scr-kaspi-reviews.png)
...
![Форма регистрации: поля «Full name», «Work email», «Password» и кнопка «Start free trial»](assets/endpoint-to-ui/scr-03-form.jpg)
...
![Форма «Новая видеовстреча»: поля названия, описания, участников, даты, длительности и типа встречи](assets/endpoint-to-ui/scr-04-meeting.jpg)
